...
namespace FileServer_API.Controllers.Users
{
    ...
    public class UserFilesController : Controller
    {
        ...
        public UserFilesController(IOptionsMonitor<JwtConfig> optionsMonitor, TokenValidationParameters tokenValidationParams, IWebHostEnvironment hostEnvironment)
        {
